...
let config = {
    ...
    "cradle_api":window.location.protocol + '//' + window.location.host + '/tools/cradle/api.php',
    "vue_components_base_url": window.location.protocol + '//' + window.location.host + '/tools/cradle/resources/vue/'
} ;
